...
image: https://res.cloudinary.com/dk9zsrfpj/image/upload/v1776108450/Gemini_Generated_Image_1bumic1bumic1bum_bkye5e.png
---
...
1. **Dürtüsellik:** Hiç düşünmeden en kolay seçeneğe yönelmek (Örneğin; iş çıkışı markette kasadaki çikolatalara yenik düşmek).
2. **Kaçınma:** Kararı tamamen ertelemek (Örneğin; önemli bir banka işlemini haftalarca yapamamak).
