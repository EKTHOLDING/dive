...
Travma, DNA dizilimini değiştirmez ancak genlerin nasıl ifade edildiğini (açılıp kapanmasını) değiştirir. Buna metilasyon denir.
...
2. Beyindeki Fiziksel Değişimler
Şiddetli veya kronik travma (özellikle çocuklukta), beynin mimarisini şu şekilde değiştirebilir:
...
3. Psikolojik Aktarım: Davranışsal Miras
Travma sadece biyolojiyle değil, öğrenilmiş davranışlarla da aktarılır. Travma yaşamış bir ebeveyn:
...
Travmanın Etkisini Kırmak Mümkün mü?
Evet. Genetik yatkınlık veya epigenetik işaretler kalıcı bir "lanet" değildir. Bilim, travmanın etkilerinin tersine çevrilebileceğini kanıtlamıştır:

Neler Yardımcı Olur?
Güvenli İlişkiler: Sağlıklı bir bağ kurmak, beyindeki stres devresini yeniden yapılandırır.
