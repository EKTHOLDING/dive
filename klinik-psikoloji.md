---
layout: default
title: Klinik Psikoloji ve Ruh Sağlığı
permalink: /klinik-psikoloji/
---

<div style="text-align:center; margin-top:20px;">
    <h1 style="font-family: 'Playfair Display', serif; color: var(--primary);">Klinik Psikoloji ve Ruh Sağlığı</h1>
...
<div class="container" style="max-width: 1200px; margin: 40px auto; padding: 0 15px;">
    <div class="gallery" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px;">
        ...
        {% for post in site.posts %}
            {% if post.kategori == 'Klinik Psikoloji ve Ruh Sağlığı' %}
